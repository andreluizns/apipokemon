...
// Inlined from src/assets/poke-page/fav-poke.svg so the fill can toggle
// between outline (inactive) and solid white (active) without needing two
// separate image assets.
export function FavoriteHeartIcon({ active, className }: FavoriteHeartIconProps) {
  return (
    <svg
      width="28"
      height="28"
